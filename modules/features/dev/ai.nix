  ...
  flake.homeModules.ai =
    ...
    in
    {
      ...
      systemd.user.services.gemma = lib.mkIf (hostName == "aiServer") {
        ...
        Service = {
          ExecStart = "${llama}/bin/llama-server -hf ${consts.models.qwen27b} -c 131072 -ctk q8_0 -ctv q8_0 -ngl 99 --host 0.0.0.0 --port 8033 --webui-mcp-proxy --jinja -t 4 -tb 4 -np 1 --kv-unified --no-mmproj";
          Restart = "on-failure";
          RestartSec = "30s";
          StartLimitBurst = 3;
