  ...
  flake.homeModules.ai =
    ...
    in
    {
      ...
      systemd.user.services.gemma = lib.mkIf (hostName == "aiServer") {
        ...
        Service = {
          ExecStart = "${llama}/bin/llama-server -hf unsloth/Qwen3.6-35B-A3B-GGUF:Q5_K_M --jinja -c 65536 --host 0.0.0.0 --port 8033 -np 2 --min-p 0.0 --webui-mcp-proxy --no-mmproj --no-mmap -t 8 -tb 8";
          Restart = "on-failure";
        };
        Install = {
